...
const Consult = () => {
  ...
  const fetchConsultations = async () => {
    setLoading(true);
    try {
       const response = await fetch(`https://stf.org.np/Backend/consultation/get_consults.php?page=${currentPage}&limit=${itemsPerPage}`);
  ...
  const updateStatus = async (id, status) => {
    try {
       const response = await fetch('https://stf.org.np/Backend/consultation/update_consult_status.php', {
