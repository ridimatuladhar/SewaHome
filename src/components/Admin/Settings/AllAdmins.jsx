...
const AllAdmins = () => {
  ...
  const handleAddAdmin = async (adminData) => {
    try {
      const response = await fetch('https://api.sewacareservices.com/admin/create_admin.php', {
  ...
  const handleBlockUnblock = async (adminId, currentStatus) => {
    ...
    try {
      ...
      const response = await fetch('https://api.sewacareservices.com/admin/update_admin_status.php', {
