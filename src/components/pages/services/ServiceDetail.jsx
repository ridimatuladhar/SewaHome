            ...
            >
              <motion.div variants={slideInVariants}>
                ...
                >
                  <motion.a
  href="/consultation"
  className="bg-white text-[#376082] px-6 py-3 md:px-8 md:py-3 rounded-lg font-semibold transition-all text-sm md:text-base inline-block"
                ...
                {['overview', 'features', 'benefits'].map((tab) => (
                  <motion.button
                    ...
                    className={`px-4 py-2 md:px-6 md:py-3 rounded-full font-semibold capitalize transition-all text-sm md:text-base ${
                      activeTab === tab 
                        ? 'bg-[#376082] text-white shadow-md' 
                        : 'text-gray-600 hover:text-[#376082]'
                    }`}
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.98 }}
                  >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-12">
              ...
              >
                ...
                {activeTab === 'features' && (
                  <motion.div
                    ...
                    animate={{ opacity: 1 }}
                    transition={{ duration: 0.5 }}
                    className="bg-white p-4 md:p-8 rounded-2xl shadow-xl border border-gray-100"
                  >
              ...
              >
                ...
                >
                  ...
                  <div>
                    <motion.div 
                      className="flex items-center gap-3 p-2 md:p-3 rounded-lg hover:bg-white/70 transition-colors"
                      whileHover={{ x: 5 }}
                    >
                    ...
                    <motion.div 
                      className="flex items-start gap-3 p-2 md:p-3 rounded-lg hover:bg-white/70 transition-colors"
                      whileHover={{ x: 5 }}
                    >
                  ...
                  <motion.a
  href="/consultation"
  className="bg-gradient-to-r from-[#376082] to-[#4A7BB7] text-white px-6 py-3 md:px-8 md:py-3 rounded-lg font-semibold transition-all text-sm md:text-base inline-block"
  whileHover={{ scale: 1.05, boxShadow: "0 10px 25px rgba(0,0,0,0.2)" }}
  whileTap={{ scale: 0.98 }}
>
