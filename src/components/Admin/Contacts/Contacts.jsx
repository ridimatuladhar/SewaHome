...
const Contacts = () => {
  ...
  const fetchContacts = async () => {
    try {
      const res = await fetch('https://stf.org.np/Backend/contact/get_contact.php');
  ...
  const handleMarkAsRead = async (id) => {
    try {
       const res = await fetch('https://stf.org.np/Backend/contact/mark_read.php', {
  ...
  const handleMarkAsUnread = async (id) => {
    try {
       const res = await fetch('https://stf.org.np/Backend/contact/mark_unread.php', {
  ...
  const handleDelete = async (id) => {
    ...
    try {
       const res = await fetch('https://stf.org.np/Backend/contact/delete_contact.php', {
