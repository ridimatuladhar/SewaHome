...
const SocialIcons = () => {
  return (
    <div className="flex items-center space-x-4">
      {/* Facebook */}
      <a
        href="https://www.facebook.com/sewahomecareservices"
        target="_blank"
      ...
      {/* Instagram */}
      <a
        href="https://www.instagram.com/sewahomecare?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
        target="_blank"
        rel="noopener noreferrer"
      ...
      {/* YouTube */}
      <a
        href="https://www.youtube.com/@sewahomecare"
        target="_blank"
        rel="noopener noreferrer"
