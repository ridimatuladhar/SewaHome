          ...
          <div className="flex-1 grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="relative mb-8">
                <div className="relative w-80 h-96 bg-[url('/about/icon.png')] bg-contain bg-no-repeat bg-center flex items-center justify-center">
                  <img
                    src={member.image}
                    alt={member.name}
              ...
              <div className="bg-white rounded-lg shadow-lg p-6 max-w-md w-full text-center">
                ...
                <button 
                  ...
                  className="bg-[#1990ff] text-white px-8 py-2 rounded-full hover:bg-blue-700 transition-colors duration-200"
            ...
            {teamMembers.map((team) => (
              ...
              >
                <div className={`p-3 rounded-lg transition-colors ${
                  team.id === id ? 'bg-[#1990ff] text-white' : 'bg-gray-100 text-gray-700'
                }`}>
