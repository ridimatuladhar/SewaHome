...
const AdminBlogs = () => {
  ...
  const fetchBlogs = async () => {
    ...
    //  const res = await fetch('http://localhost/SewaHome/Backend/Blog/get_blogs.php?admin=true');
      const res = await fetch('https://stf.org.np/Backend/Blog/get_blogs.php?admin=true');
  ...
  const handleDelete = async (id) => {
    ...
    try {
     // const res = await fetch('http://localhost/SewaHome/Backend/Blog/delete_blog.php', {
      const res = await fetch('https://stf.org.np/Backend/Blog/delete_blog.php', {
        method: 'POST',
  ...
  const togglePublish = async (blog) => {
    try {
      ...
      const res = await fetch('https://stf.org.np/Backend/Blog/update_blog.php', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          ...blog,
                ...
                <div className="md:w-48 h-full bg-gray-100 flex-shrink-0">
                  {blog.featured_image ? (
                    <img
                     ...
                     src={`https://stf.org.np/Backend${blog.featured_image}`}
                      alt={blog.title}
